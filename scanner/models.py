...
class EvidenceStatus(str, Enum):
    ...
    CONFIRMED_DELEGATED_CHILD_ZONE_RECURSIVE = "CONFIRMED_DELEGATED_CHILD_ZONE_RECURSIVE"
    """Delegation corroborated via ≥2 recursive resolvers; lower confidence than authoritative."""
    ...
    Withheld from confirmed findings as a likely wildcard/parking echo (WC-FIX.1 2B).
    Applied when wildcard detection was INCONCLUSIVE or CLEAN but the TXT content
    matches a recognised parking registrar string (e.g. i-theta.com / buddyns.com).
...
class FindingClassification(str, Enum):
    ...
    DELEGATED_CHILD_ZONE_RECURSIVE = "delegated_child_zone_recursive"
    """Delegation corroborated by ≥2 recursive resolvers; never authoritative."""
